...
export default function Stepper({
  ...
  return (
    <div className="stepper-outer-container" {...rest}>
      <div
        className={`step-circle-container border border-rule bg-white dark:border-dark-border dark:bg-dark-card ${stepCircleContainerClassName}`}
      >
            ...
            <div className={`footer-nav ${currentStep !== 1 ? "spread" : "end"}`}>
              {currentStep !== 1 && (
                <button
                  type="button"
                  onClick={handleBack}
                  className={`back-button text-mute dark:text-dark-mute ${currentStep === 1 ? "inactive" : ""}`}
                  {...backButtonProps}
                >
                  {backButtonText}
                </button>
              ...
              <button
                ...
                className="next-button font-mono uppercase tracking-[0.08em]"
                {...nextButtonProps}
              >
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#E1ECE5", color: "#48685A" },
          active: { scale: 1.05, backgroundColor: "#059669", color: "#FFFFFF" },
